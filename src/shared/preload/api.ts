...
export type PlanningImportJsonResult = { success?: boolean; created?: number; canceled?: boolean; conflicts?: Array<{ original: string; resolved: string }>; errors?: Array<{ reason: string }> }
